    ...
    try {
        ...
        if (data && data.length > 0) {
            ...
            player.on('error', function() {
                ...
                if (errorCount <= 3) {
                    // 在页面底部显示提示
                    var notice = $('<div id="play-notice" style="text-align:center;padding:10px 20px;background:#f8d7da;color:#721c24;border-radius:8px;font-size:13px;border:1px solid #f5c6cb;margin-top:15px;">该歌曲暂时无法播放，正在播放下一首</div>');
